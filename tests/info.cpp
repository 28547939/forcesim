...
int main (int argc, char* argv[]) {
    ...
    client.options_desc.add_options()
        ("test-count", po::value<int>()->default_value(10), "")
        ("agent-count-max", po::value<int>()->default_value(10), "")
        ("infoset-size-max", po::value<int>()->default_value(10), "")
        ("info-count-max", po::value<int>()->default_value(10), "")
        ("iter-max", po::value<int>()->default_value(10), "")
    ;
    ...
    auto info_count_max = client.options_vm["info-count-max"].as<int>();
    ...
    for (int test_i = 0; test_i < test_count; test_i++) {
        ...
        int info_count = rand(info_count_max);
        std::cout << "info_count=" << std::to_string(info_count) << "\n";
