...
TMPDIR=$WORKDIR clang++ -g -O0 -c -std=c++20 -ferror-limit=100 -pthread -I/usr/local/include/  \
	...
	-fdiagnostics-fixit-info \
	 json_conversion.cpp Subscriber.cpp Market.cpp Interface.cpp Agent.cpp  test_interface.cpp
...
clang++ -o test-interface -lglog -L/usr/local/lib -pthread  test_interface.o Interface.o json_conversion.o Agent.o  Market.o Subscriber.o
